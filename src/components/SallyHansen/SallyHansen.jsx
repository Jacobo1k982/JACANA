// SallyHansen.jsx - Versión ULTRA Premium ✨
              ...
              #f5f9ff 100%
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
                    <motion.h1
                        ...
                        className="text-3xl sm:text-4xl md:text-6xl font-extrabold text-white drop-shadow-2xl tracking-tight"
                    >
                        Sally Hansen
                    </motion.h1>
                    <motion.p
                    ...
                    >
                        Esmaltes, cuidado de uñas y belleza que brilla. Calidad profesional en casa.
                    </motion.p>
                </div>
            ...
            <div className="max-w-7xl mx-auto px-4 pb-16">
                <div className="relative">
                    ...
                    {!isLoading && productos.length > 0 && (
                        <div className="absolute -bottom-2 left-0 right-0 h-1 bg-gray-200 dark:bg-gray-800 rounded-full">
                            <motion.div
                                className="h-full bg-gradient-to-r from-pink-400 via-red-500 to-rose-500 rounded-full"
                ...
                >
                    <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400 leading-relaxed font-Poppins">
                        Descubre la colección completa de <strong>Sally Hansen</strong>:
                        desde esmaltes clásicos hasta innovaciones como <strong>Miracle Gel</strong> y <strong>Good. Kind. Pure.</strong>
                        Belleza profesional, fórmulas avanzadas y colores que duran.
                    </p>
                </motion.div>
            </div>
