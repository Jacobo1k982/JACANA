...
const Ropa = ({ ropa: { title, subtitle, news } }) => {
    const splideOptions = {
        perPage: 3,
        perMove: 1,
        type: "loop",
    ...
    return (
        ...
        >
            <div className="max-w-7xl w-full mx-auto flex flex-col items-center justify-center text-center gap-12 xs:gap-8">
                ...
                >
                    <span className="text-5xl sm:text-6xl xs:text-3xl text-amber-400 block">Explora</span>
                    <span className="text-3xl sm:text-6xl xs:text-2xl block">las categorías</span>
                </motion.h2>
