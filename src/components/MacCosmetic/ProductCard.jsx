// ProductCard.jsx - Versión Premium (usada en Mañanitas)
    ...
    return (
        ...
        >
            <div className="relative h-48 sm:h-44 xs:h-40 bg-gray-50 dark:bg-gray-800 flex items-center justify-center overflow-hidden">
                ...
                {product.badge && (
                    <div className={`absolute top-2 text-xs font-bold uppercase px-2 py-1 rounded-full text-white shadow-lg ${product.badge.toUpperCase() === 'NEW'
            ...
            <div className="p-4 text-center flex flex-col flex-grow">
                ...
                >
                    <span className="relative z-10 flex items-center justify-center gap-1">
                        Ver Detalles
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 opacity-0 group-hover/btn:opacity-100 transition-opacity duration-300" viewBox="0 0 20 20" fill="currentColor">
                            <path fillRule="evenodd" d="M10.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L12.586 11H5a1 1 0 110-2h7.586l-2.293-2.293a1 1 0 010-1.414z" clipRule="evenodd" />
                        </svg>
                    </span>
                    <span className="absolute inset-0 bg-gradient-to-r from-transparent via-white/40 to-transparent -translate-x-full group-hover/btn:translate-x-full transition-transform duration-700" style={{ transform: 'translateX(-100%)' }} />
                </button>
            </div>
        </div>
    );
