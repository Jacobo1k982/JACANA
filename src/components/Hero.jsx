    ...
    <div className='relative h-auto w-auto flex flex-col'>
      ...
      <div className='relative opacity-100 z-20 grid items-center justify-items-center nike-container'>
        <div className='grid items-center justify-items-center mt-28 md:mt-24'>
          ...
          <div className='grid items-center gap-4 md:gap-3 absolute top-[35vh] lg:top-[35vh] left-[1%] xl:left-0 w-auto h-auto'>{videos?.map((val, i) => (
            <Clips
              key={i}
              imgsrc={val.imgsrc}
              clip={val.clip}
        ...
        <div className='flex items-center'>
          <img
            src={img}
            alt="hero-img/img"
            className='w-auto h-[41vh] lg:h-[35vh] md:h-[31vh] sm:h-[21vh] xsm:h-[19vh] transitions-theme -rotate-[25deg] hover:-rotate-[0deg] cursor-pointer object-fill'
          />
        </div>
      </div>
    </div>
