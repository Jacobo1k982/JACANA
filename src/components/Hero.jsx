      ...
      <div className='relative opacity-100 z-20 grid items-center justify-items-center nike-container'>
        <div className='grid items-center justify-items-center mt-28 md:mt-24'>
          <div className='text-container w-full flex flex-col items-center'> {/* Contenedor adicional */}
            <h1 className='text-7xl lg:text-5xl md:text-4xl sm:text-3xl xsm:text-2xl font-extrabold filter drop-shadow-sm text-slate-200 text-center'>{title}</h1>
        ...
        <div className='flex items-center justify-center hero-image-container'> {/* Nueva clase aquí */}
          <img
            ...
            style={{ width: '45%', height: 'auto' }} // Cambia el tamaño de la imagen aquí
          />
        </div>
      </div>
    </div>
