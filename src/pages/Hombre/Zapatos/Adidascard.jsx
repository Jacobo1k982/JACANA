...
function Adidascard() {
    const products = [
        { img: "/ADSH/ADSH1.jpg", title: "Adidas", model: "Modelo Exclusivo", size: "Talla: 40-43", price: "¢ 30.000" },
        { img: "/ADSH/ADSH2.jpg", title: "Adidas", model: "Modelo Exclusivo", size: "Talla: 40-42", price: "¢ 24.000" },
    ]
};
